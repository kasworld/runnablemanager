...
import "github.com/kasworld/rangestat"
...
func (raman *RunnableManager) GetRunnableByWorkerID(n int) RunnableI {
	return raman.runnableList[n]
}

func (raman *RunnableManager) GetAll() []RunnableI {
	return raman.runnableList[:]
}
